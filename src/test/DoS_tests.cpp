...
BOOST_AUTO_TEST_CASE(DoS_checknbits)
{
    ...
    // FCYIAD: TEST REMOVED  BOOST_CHECK(!CheckNBits(firstcheck.second, lastcheck.first+60*10, lastcheck.second, lastcheck.first));
    // FCYIAD: TEST REMOVED  BOOST_CHECK(!CheckNBits(firstcheck.second, lastcheck.first+60*60*24*14, lastcheck.second, lastcheck.first));
