...
#if defined(NDEBUG)
# error "Fancycoin cannot be compiled without assertions."
#endif
...
static const int64_t nTargetTimespan = 60; // 1 minute
static const int64_t nTargetSpacing = 30; // 0.5 minutes
static const int64_t nInterval = 2; // retargets every 2 blocks

static const int64_t nAveragingInterval = 40; // 40 blocks
static const int64_t nAveragingTargetTimespan = nAveragingInterval * nTargetSpacing; // 40 minutes

static const int64_t nMaxAdjustDown = 10; // 10% adjustment down
static const int64_t nMaxAdjustUpV1 = 5; // 5% adjustment up
static const int64_t nMaxAdjustUpV2 = 10; // 10% adjustment up
