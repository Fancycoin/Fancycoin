...
uint256 hashGenesisBlock("0x70fd9c468b516227463fc21f94260d9ff7d07c483af8e8c111e3232da8201e58");
...
const string strMessageMagic = "Fancycoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 720) // no block reward within the first day (fair mining)
        nSubsidy = 0;
    if(nHeight > 1314000) // no block reward after 5 years
        nSubsidy = 0;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Retarget every day
static const int64 nTargetSpacing = 120; // Blocks going out every 2 mins
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Fancycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Fancycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1bbcbd40e755c290fca7c5ba987783d7ccdd703c875abd41fa8d40ffc58f893c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1426931334;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086162558;

        if (fTestNet)
        {
            block.nTime    = 1426931334;
            block.nNonce   = 386535413;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x98538202434e9d1394c7c3b7a4a9a49c2658890e05fe8a04d030b974142dbf93"));
